...
export const commands: Command[] = [
  ...
  },
  {
    ...
    resp2: "Array of alternating field names and values.",
  ...
  },
  {
    ...
    resp2: "Nested arrays describing commands, arity, flags, key specs, and metadata.",
    resp3: "Nested maps/arrays for richer command metadata where applicable.",
  ...
  },
  {
    ...
    ...same("Array [next-cursor bulk string, array of keys]."),
  ...
  },
  {
    ...
    ...same("Array of matching key names."),
  ...
  },
  {
    ...
    resp2: "Array [next-cursor, flat array field/value pairs or fields].",
    resp3: "Array [next-cursor, array/map-like aggregate depending on server/protocol].",
  ...
  },
  {
    ...
    resp2: "Without count: bulk string or null bulk string. With count: array or null bulk string when missing.",
    resp3: "Without count: blob string or null. With count: array or null when missing.",
  ...
  },
  {
    ...
    ...same("Array of elements, empty array for missing key or empty range."),
  ...
  },
  {
    ...
    resp2: "Array [key, element], or null array *-1 on timeout.",
    resp3: "Array [key, element], or null on timeout.",
  ...
  },
  {
    ...
    params: ["key: set key."],
    resp2: "Array of members.",
    resp3: "Set aggregate of members.",
  ...
  },
  {
    ...
    ...same("Array [next-cursor, array of members]."),
  ...
  },
  {
    ...
    ...same("Array of members, or flat array member/score pairs with WITHSCORES."),
  ...
  },
  {
    ...
    resp2: "Integer rank, null bulk string when missing; with WITHSCORE: array [rank, score].",
    resp3: "Integer rank or null; with WITHSCORE: array [rank, score].",
  ...
  },
  {
    ...
    ...same("Array [next-cursor, flat array member/score pairs]."),
  ...
  },
  {
    ...
    resp2: "Array of [id, flat field/value array] entries.",
    resp3: "Array of [id, map of field => value] entries.",
  ...
  },
  {
    ...
    resp2: "Null bulk/array on timeout, otherwise array of [stream, entries].",
    resp3: "Null on timeout, otherwise map of stream => entries.",
  ...
  },
  {
    ...
    resp2: "Null on timeout, otherwise array of [stream, entries].",
    resp3: "Null on timeout, otherwise map of stream => entries.",
  ...
  },
  {
    ...
    resp2: "Connection enters subscribed mode; arrays like [subscribe, channel, count] and [message, channel, payload].",
    resp3: "Push messages for subscribe/message events; connection can also issue other commands.",
  ...
  },
  {
    ...
    resp2: "Arrays like [psubscribe, pattern, count] and [pmessage, pattern, channel, payload].",
    resp3: "Push messages for pattern subscription events.",
  ...
  },
  {
    ...
    resp2: "Array acknowledgements [unsubscribe, channel, remaining-count].",
    resp3: "Push acknowledgements for unsubscribe events.",
  ...
  },
  {
    ...
    signature: "EXEC",
    params: ["No arguments."],
    resp2: "Array of queued command replies, or null array if WATCH invalidated the transaction.",
    resp3: "Array of queued command replies, or null if WATCH invalidated the transaction.",
  ...
  },
  {
    ...
    ...same("Array of integers: 1 exists, 0 missing."),
  ...
  },
  {
    ...
    params: ["No arguments."],
    resp2: "Nested arrays: [start-slot, end-slot, master, replica ...].",
    resp3: "Nested arrays/maps depending on Redis version; includes slot ranges and node endpoints.",
